...
-- Full script with webhook GIF support
-- Only the webhook() function has been updated to include an image (GIF)

-- ... [all original script content above remains unchanged] ...
local function webhook(raised, donor)
    ...
    local embed = {
        ...
        image = {
            url = "https://media.tenor.com/2roX3uxz_68AAAAC/cat-computer.gif" -- ✅ GIF ditambahkan di embed
        },
...
-- ... [all original script content below remains unchanged] ...
